...
def generate_population_dictionary_from_csvfile(filename):
  
  """Function to generate population dictionary from csv file"""
  ...
  with open(filename, 'r') as csvfile:
    ...
    for line in reader:
      ...
      """Returning the population per continent in dictionary form:
      [
        'Africa':{'population':4567678,'years':2003}
        'Europe':{'population':786543465768,'years':2021}
...
population_per_continent = generate_population_dictionary_from_csvfile(filename)

def population_dictionary_plot(population_dictionary):
  """Function to generate plot of population dictionary"""
...
population_dictionary_plot(population_per_continent)
